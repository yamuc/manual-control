...
p.name = "yc-switch"
p.minable.result = "yc-switch"

p.icon = "__manual-control__/graphics/switch/switch-icon.png"
p.icon_size = 32
p.icon_mipmaps = 1

local sprite = {
  filename = "__manual-control__/graphics/switch/switch.png",
  width = 64,
  height = 44,
  frame_count = 1,
  --shift = {0.4375, 0.3125},
...
local activity_led_sprite = {
  filename = "__manual-control__/graphics/button/button-activity-led.png",
  width = 11,
  height = 10,
  frame_count = 1,
